...
An end-to-end unsupervised and supervised machine learning framework for dynamic structural health monitoring, modal parameter analysis (MAC), and sensor layout optimization under measurement noise.
...
shm-machine-learning-damage-detection/
├── figures/
│   ├── Damage_Heatmap.png
